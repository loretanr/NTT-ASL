...
//          "\n      (8: playground)"
    ...
    case 0:
        ...
        perm = new perm_prefix_cond(n, cond_0, visit);  break;
    case 1:
        cout << "Involutions (self-inverse permutations):" << endl;
        perm = new perm_prefix_cond(n, cond_invol, visit);  break;
    case 2:
    ...
    case 3:
        ...
        perm = new perm_prefix_cond(n, cond_indecomp, visit);  break;
    case 4:
        cout << "Derangements:" << endl;
        perm = new perm_prefix_cond(n, cond_derange, visit);  break;
    case 5:
        cout << "No [x,x+1]:" << endl;
        perm = new perm_prefix_cond(n, cond_xx1, visit);  break;
    case 6:
        cout << "Distance <=2 :" << endl;
        perm = new perm_prefix_cond(n, cond_dist, visit);  break;

    case 7:
        cout << "Playground:" << endl;
        perm = new perm_prefix_cond(n, cond_dist_set, visit);  break;
    case 8:
        cout << "Playground:" << endl;
        perm = new perm_prefix_cond(n, cond_gt_k2, visit);  break;

    case 10:
        cout << "Playground:" << endl;
        perm = new perm_prefix_cond(n, cond_cyc_dist, visit);  break;

    case 11:
        cout << "Canonical Gray cycles:" << endl;
        perm = new perm_prefix_cond(n, cond_gray, visit);  break;

    case 12:
        cout << "Ascends and descends of length at least 2:" << endl;
        perm = new perm_prefix_cond(n, cond_asc_desc_geq_2, visit);  break;
...
/// MyRelDir: "demo/comb"
/// makefile-dir: "../../"
/// make-target: "1demo DSRC=demo/comb/perm-prefix-cond-demo.cc"
/// make-target2: "1demo DSRC=demo/comb/perm-prefix-cond-demo.cc DEMOFLAGS=-DTIMING"
/// End:
