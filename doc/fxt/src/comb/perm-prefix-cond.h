#if !defined  HAVE_PERM_PREFIX_COND_H__
#define       HAVE_PERM_PREFIX_COND_H__
// This file is part of the FXT library.
// Copyright (C) 2010, 2011, 2012, 2014, 2019, 2020 Joerg Arndt
...
protected:
    ...
    perm_prefix_cond(const perm_prefix_cond&) = delete;
    perm_prefix_cond & operator = (const perm_prefix_cond&) = delete;

public:
    explicit perm_prefix_cond(ulong nn,
...
#endif  // !defined HAVE_PERM_PREFIX_COND_H__
